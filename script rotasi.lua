...
-- Storage Worlds for Seed (Auto Spread Worlds)
-- For example, if you have 3 bots and 3 world storages, each bot will have a different world.
storageSeedWorlds = {
        "XTYV1|FSCKLN0L11"
}

-- Storage Worlds for Pack (Auto Spread Worlds)
storagePackWorlds = {
"JOSPARJOSGEN|FSCKLN0L11",
"BUSUNGLAMKA|FSCKLN0L11",
...
-- Leveling Settings
leveling = true -- Bot will do factory first until X level
untilLevel = 13
levelingBlockID = 880
-- Leveling World (DF)
levelingWorlds = {
"JOISHERWHEAT|FSCKLN0L11",
"JOISHERWHEAT2|FSCKLN0L11",
"JOISHERWHEAT3|FSCKLN0L11",
}
-- Storage for Taking & Dropping Seeds
levelingStorages = {
    "JOISALLTOGRIND|FSCKLN0L11"
}
...
firehoseStorage = "romofamilia" -- World For Taking Firehose
...
pnbInTutorial = false -- Bot will perform PNB in its tutorial world.
ownerWhiteList = "jakisukasolat" -- Your GrowID to avoid banned by the bot since it already use autobanned people feature.
...
autoCreatePnbWorld = true -- Bot will create pnb World locked with Small Lock
putJammer = true
jammerStorageWorld = "SIGNALJOISHER"
jammerStorageDoorID = "FSCKLN0L11"
...
joinRandomWorld = true -- Joining Random World After From Storage
randomWorldList = {"BUYFISHs", "DAW",  "NRIY", "PEMANCINGAN", "BUYARROZ", "BUYCASINO", "UAUSM"}
